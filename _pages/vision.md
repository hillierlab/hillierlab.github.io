...
<p>The key to our success is a multidisciplinary approach. We apply a wide range of methodologies, from molecular biology and the design of viral-therapy vectors to behavioral research.  <div style="display:flex; align-items:right; gap:16px; margin-bottom:12px;border-radius 50% / 50%; border: 3px solid #000;>
                                                                                                                                      <img class="photo-left" src="/assets/images/wordcloud_eye.png" style="float:right; margin 0 0 10px 10px height:10px; width:auto;" 
