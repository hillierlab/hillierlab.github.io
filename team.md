...
<div style="display: flex; align-items: center; margin-bottom: 2em; flex-direction: row-reverse;">
  <img src="/assets/images/member_photos/Dani2.JPEG" alt="Member Name" style="width: 150px; height: 150px; aspect-ratio: 1 / 1; border-radius: 50%; object-fit: cover; margin-left: 20px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 2em; flex-direction: row;"> 
  <img src="/assets/images/member_photos/Doma.JPEG" alt="Member Name" style="width: 150px; height: 150px; aspect-ratio: 1 / 1; border-radius: 50%; object-fit: cover; margin-right: 20px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 2em; flex-direction: row-reverse;">
  <img src="/assets/images/member_photos/B.Luca.jpg" alt="Member Name" style="width: 150px; height: 150px; aspect-ratio: 1 / 1; border-radius: 50%; object-fit: cover; margin-left: 20px;">
  <div>
    <h3>Luca Benedek</h3>
